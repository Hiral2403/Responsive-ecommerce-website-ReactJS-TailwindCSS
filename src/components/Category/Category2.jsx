    ...
    return (
        <div className="py-8">
            <div className="container mx-auto">
                ...
                {/* sec col */}
                <div className="py-10 pl-5 bg-gradient-to-br from-green-400 to-green-400 text-white rounded-3xl relative h-[320px] flex items-start">
                    <div>
                        <div className="mb-4">
                            <p className="mb-[2px] text-whitw">Enjoy</p>
                            <p className="text-2xl font-semibold mb-[2px]">With</p>
                ...
                {/* third col  */}
                <div className="py-10 pl-5 bg-gradient-to-br from-sky-500 to-sky-500 text-white rounded-3xl relative h-[320px] flex items-start">
                    <div>
                        <div className="mb-4">
                            <p className="mb-[2px] text-white">Enjoy</p>
                            <p className="text-2xl font-semibold mb-[2px]">With</p>
                            <p className="text-4xl xl:text-5xl font-bold opacity-40 mb-2">Gadget</p>
                            <Button text="Browse" bgColor={'bg-white'} textColor={'text-sky-500'} />
                        </div>
                    </div>
